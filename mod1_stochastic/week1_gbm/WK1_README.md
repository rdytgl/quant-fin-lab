...
The [first code](gbm_simulator.py) simulates 1000 paths of an asset price starting at 100 with an annualised drift of 0.10 and annualised volatilty of 0.20.
